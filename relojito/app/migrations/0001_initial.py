    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date(2014, 10, 3))),
                ('total_hours', models.FloatField(validators=[django.core.validators.MinValueValidator(0.5), django.core.validators.RegexValidator(b'^(\\d(\\.[05])?)$', b'Only .5 numbers')])),
                ('external_url', models.URLField(null=True, blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('owner', models.ForeignKey(to=settings.AUTH_USER_MODEL, null=True)),
